          ...
          <TextPostContainer>
            ...
            <TextBody>
              ...
              <H6>
                ...
                nódulo ou caroço, saída de secreção pelo mamilo, retração na aréola e/ou mamilo ou
                dor persistente.
              </H6>
            </TextBody>
            <TextBody>
            ...
            <TextBody>
              ...
              <H6>
                ...
                parentes de primeiro grau, como mãe, irmã e filha, a mastologista deve ser procurada
                para avaliação do seu risco individual e determinação da melhor estratégia para
      ...
      <div id="PostModel3">
        <PostModel3>
          <TextPostContainer>
            ...
            <H6>
              Rastreamento é quando não há nenhuma queixa ou sintoma aparente (como nódulo palpável)
              e realiza-se exame específico para descobrir o câncer de mama na sua fase inicial. O
              exame de escolha para rastreamento é a mamografia, sendo indicada a sua realização uma
              vez ao ano, a partir dos 40 anos, conforme orientação da Sociedade Brasileira de
              Mastologia, Federação Brasileira das Associações de Ginecologia e Obstetrícia e o
              Colégio Brasileiro de Radiologia.
            </H6>
            <H6>
              Quando a mulher apresenta histórico familiar de câncer de mama, deve consultar com uma
              mastologista para definir qual a melhor idade para iniciar o rastreamento, quais
              exames devem ser realizados e qual a periodicidade deles, além de outras orientações e
              cuidados conforme cada caso.
            </H6>
            <H6>
